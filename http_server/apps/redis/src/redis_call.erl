...
create_pool(PoolName, Size, Host, Port) ->
    redis_sup:create_pool(PoolName, Size, [{host, Host}, {port, Port}]).
...
delete_pool(PoolName) ->
    redis_sup:delete_pool(PoolName).
